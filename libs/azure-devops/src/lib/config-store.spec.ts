...
describe('readGlobalConfig', () => {
  ...
  it('reads from the global config path', () => {
    ...
    expect(mockReadFileSync).toHaveBeenCalledWith(
      '/home/testuser/.kirby/config.json',
      'utf8'
    );
  });
});
...
describe('readProjectConfig', () => {
  ...
  it('reads from the per-project config path', () => {
    ...
    expect(mockReadFileSync).toHaveBeenCalledWith(
      '/home/testuser/.kirby/projects/abcdef1234567890/config.json',
      'utf8'
    );
  });
});
...
describe('writeProjectConfig', () => {
  ...
  it("creates directories if they don't exist", () => {
    ...
    expect(vi.mocked(mkdirSync)).toHaveBeenCalledWith(
      '/home/testuser/.kirby/projects/abcdef1234567890',
      { recursive: true }
    );
  });
...
describe('readConfig', () => {
  ...
  it('merges defaults, global, and project configs', () => {
    ...
    mockReadFileSync
      ...
      .mockReturnValueOnce(
        JSON.stringify({ org: 'myorg', project: 'myproj', repo: 'myrepo' })
      );
